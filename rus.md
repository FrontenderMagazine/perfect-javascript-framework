...
фрейморка на все случаи жизни. Так что, мы сталкиваемся с задачами, у которых
...
Мы передаём элемент DOM, в котором следует разместить список, и вызываем функцию
...
Браузер перерисовывает только ту часть, которая именилась.
...
происхоит когда браузер отрисовывает HTML, но загрузочные механизмы AngularJS
