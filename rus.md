...
вернуть публичный API нашего модуля. Иначе код, запросивший наш модуль, не
...
AJAX-запросах, а API должен быть таким, чтобы процесс выглядел синхронным.
